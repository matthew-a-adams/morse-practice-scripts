...
def main(freq, wpm, fs, prompt, outFile, inFile):

  #messages = ['E', 'T', 'A', 'N', 'S', 'I', 'O', 'R', 'H', 'D', 'L', 'U', 'C', 'W', 'M', '1', '2', '3', '4', '5', '6', '?']
  ...
  for message in messages:
    ...
    # Play morse code audio from plain text
...
if __name__ == '__main__':
  ...
  main(args.f, args.wpm, args.fs, args.p, args.o, args.i)
